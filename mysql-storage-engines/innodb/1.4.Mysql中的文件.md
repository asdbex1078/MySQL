...
![1.4.2.redo log buffer和 redo log]()
...
![1.4.3.redo log buffer 和 redo log示意图2]()
...
![1.4.4.innodb_flush_log_at_trx_commit参数的意义]()
...
![1.4.11.chekpoint和writepoint的例子]()
...
3. 写入时间不同
   ...
   - redo log，在事务进行过程中，不断被写入重做日志文件中。
     ![1.4.1.bin log和redo log写入的差异.png]()
